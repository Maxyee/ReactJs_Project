                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="container PopupSignup">
                                ...
                                <input className="signupFrom" type="email" name="Email" id="Email" placeholder="Email" required autoComplete="off"/>
                                
                                <input className="signupFrom" type="password" name="Password" placeholder="Password (minimum 8 characters)" pattern=".{8,}" required title="Must be at least 8 characters" autoComplete="off"/>
                                <br/>
